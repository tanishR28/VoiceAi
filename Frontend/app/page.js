        ...
        <div className="p-6 md:p-10 max-w-7xl mx-auto w-full space-y-10">
          <section className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="space-y-2">
              <h2 className="text-4xl font-extrabold text-on-surface tracking-tight font-headline">Good Morning, Dr. Sarah</h2>
              ...
              <div className="relative w-48 h-48 flex items-center justify-center group cursor-pointer transition-transform duration-500 hover:scale-[1.02]">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center z-20">
                  <span className="text-6xl font-extrabold font-headline text-primary leading-none tracking-tighter">
                    {analysisData ? analysisData.health_score : 92}
                  </span>
            ...
            <div className="lg:col-span-8 bg-surface-container-lowest border border-gray-100 rounded-[18px] p-6 lg:p-8 flex flex-col hover-lift shadow-sm relative">
              <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-8 z-10 w-full">
                <div className="flex-1">
                  ...
                  <p className="text-slate-500 font-medium text-sm mt-1">Historical data from the last 30 days</p>
                  <div className="mt-4 flex items-center p-3 rounded-xl bg-blue-50/70 border border-blue-100/50 w-fit">
                    <p className="text-xs font-semibold text-blue-800 leading-tight">
                      "Your voice stability has improved consistently over the past 3 days."
                    </p>
                  </div>
                </div>
                <div className="flex flex-wrap gap-2 bg-slate-50 p-1 rounded-xl border border-gray-100 shrink-0">
                  <button className="px-5 py-2 bg-white text-primary shadow-sm rounded-lg text-sm font-bold transition-all">Month</button>
                  <button className="px-5 py-2 text-slate-400 hover:text-slate-700 rounded-lg text-sm font-bold transition-colors">Week</button>
                </div>
              </div>
              <div className="flex-1 min-h-[260px] relative z-0 mt-4 sm:mt-0">
                <div className="absolute inset-0 flex items-end justify-between px-2 opacity-50 transition-opacity hover:opacity-80">
                  <div className="h-[60%] w-[4%] bg-primary/10 rounded-t-lg transition-all hover:bg-primary/30"></div>
                  <div className="h-[65%] w-[4%] bg-primary/10 rounded-t-lg transition-all hover:bg-primary/30"></div>
                  <div className="h-[55%] w-[4%] bg-primary/10 rounded-t-lg transition-all hover:bg-primary/30"></div>
                  <div className="h-[75%] w-[4%] bg-primary/10 rounded-t-lg transition-all hover:bg-primary/30"></div>
                  <div className="h-[85%] w-[4%] bg-primary/10 rounded-t-lg transition-all hover:bg-primary/30"></div>
                  <div className="h-[80%] w-[4%] bg-primary/20 rounded-t-lg transition-all hover:bg-primary/40"></div>
                  <div className="h-[90%] w-[4%] bg-primary/30 rounded-t-lg transition-all hover:bg-primary/50"></div>
                  <div className="h-[85%] w-[4%] bg-primary/40 rounded-t-lg transition-all hover:bg-primary/60"></div>
                  <div className="h-[95%] w-[4%] bg-primary rounded-t-lg shadow-[0_0_15px_rgba(0,86,187,0.3)]"></div>
                </div>
                ...
                <svg className="absolute inset-0 w-full h-full overflow-visible" preserveAspectRatio="none">
                  ...
                  {mounted && (
                    <>
                      <path className="w-full h-full anim-fill" d="M0,180 Q50,160 100,170 T200,140 T300,120 T400,150 T500,100 T600,110 T700,90 L700,240 L0,240 Z" fill="url(#line-fill)" stroke="none"></path>
                      <path className="w-full h-full anim-draw" d="M0,180 Q50,160 100,170 T200,140 T300,120 T400,150 T500,100 T600,110 T700,90" fill="none" stroke="#0056bb" strokeLinecap="round" strokeWidth="4"></path>
                    </>
                  )}
                  {/* Latest Data Point Group */}
                    ...
                    <g className="opacity-0 group-hover/tooltip:opacity-100 transition-opacity duration-300 pointer-events-none">
                       ...
                       <text x="0" y="-35" fill="white" fontSize="13" fontWeight="bold" fontFamily="Inter" textAnchor="middle">{analysisData ? analysisData.health_score : 92} / 100</text>
            ...
            <div className="lg:col-span-12 grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-surface-container-lowest p-6 rounded-[18px] hover-lift shadow-sm border border-gray-200 flex flex-col gap-4 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <h4 className="text-3xl font-extrabold font-headline text-slate-900 tracking-tight">
                    {analysisData ? Math.round(analysisData.breath_score * 100) : 78}%
                  </h4>
                </div>
                <div className="w-full bg-slate-100 h-[6px] rounded-full overflow-hidden mt-2 relative z-10">
                  <div className="bg-primary h-full rounded-full shadow-[0_0_8px_rgba(0,86,187,0.5)]" style={{ width: `${analysisData ? Math.round(analysisData.breath_score * 100) : 78}%` }}></div>
                </div>
              </div>
              ...
              <div className="bg-surface-container-lowest p-6 rounded-[18px] hover-lift shadow-sm border border-gray-200 flex flex-col gap-4 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <h4 className="text-3xl font-extrabold font-headline text-slate-900 tracking-tight">
                    {analysisData ? (analysisData.pitch_variation > 0.15 ? 'High' : 'Low') : 'Low'}
                  </h4>
                </div>
              ...
              <div className="bg-surface-container-lowest p-6 rounded-[18px] hover-lift shadow-sm border border-gray-200 flex flex-col gap-4 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <h4 className="text-3xl font-extrabold font-headline text-slate-900 tracking-tight">
                     {analysisData ? (analysisData.speech_rate > 3.5 ? 'Moderate' : 'High') : 'High'}
                  </h4>
                </div>
            ...
            <div className="lg:col-span-12">
              <div className="bg-surface-container-lowest rounded-[18px] border border-gray-200 p-8 shadow-sm">
                ...
                <div className="space-y-4">
                  <div className="bg-white border border-gray-100 p-5 rounded-2xl flex items-center justify-between group hover:shadow-md hover:border-gray-200 transition-all cursor-pointer hover:-translate-y-[1px]">
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        <div className="font-bold text-slate-900 text-[15px] group-hover:text-primary transition-colors">Morning Check-in</div>
                        <div className="text-sm font-medium text-slate-400 mt-0.5">May 24, 2024 • 08:30 AM</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-6">
                      <div className="text-right hidden sm:block">
                        <div className="text-[15px] font-bold text-slate-900">94<span className="text-slate-400 text-xs text-normal">/100</span></div>
                        <div className="text-[10px] text-secondary font-black uppercase tracking-widest mt-0.5">Stable</div>
                      </div>
                  ...
                  <div className="bg-white border border-gray-100 p-5 rounded-2xl flex items-center justify-between group hover:shadow-md hover:border-gray-200 transition-all cursor-pointer hover:-translate-y-[1px]">
                    <div className="flex items-center gap-5">
                      <div className="w-12 h-12 rounded-xl bg-orange-50 flex items-center justify-center text-orange-600 group-hover:scale-105 transition-transform">
                        <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>warning</span>
                      </div>
                      <div>
                        <div className="font-bold text-slate-900 text-[15px] group-hover:text-primary transition-colors">Weekly Comprehensive</div>
                        <div className="text-sm font-medium text-slate-400 mt-0.5">May 18, 2024 • 11:15 AM</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-6">
                      <div className="text-right hidden sm:block">
                        <div className="text-[15px] font-bold text-slate-900">88<span className="text-slate-400 text-xs text-normal">/100</span></div>
                        <div className="text-[10px] text-orange-600 font-black uppercase tracking-widest mt-0.5">Slight Change</div>
                      </div>
                      <div className="w-8 h-8 rounded-full bg-gray-50 flex items-center justify-center group-hover:bg-primary/5 transition-colors">
                         <span className="material-symbols-outlined text-gray-400 group-hover:text-primary transition-colors text-xl">chevron_right</span>
                      </div>
